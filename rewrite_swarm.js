...
const content = `import { AgentRole, SwarmMemory, SwarmFinalOutput } from "./types";
...
fs.writeFileSync(path.join(process.cwd(), 'src/core/swarm/swarmRunner.ts'), content);
console.log("Successfully rewrote swarmRunner.ts");
